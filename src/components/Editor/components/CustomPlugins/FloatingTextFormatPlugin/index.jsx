...
export default function FloatingTextFormatToolbarPlugin({
  ...
  useEffect(() => {
    // Check if the anchorElem is null and if we are on the client-side
    const isClientSide = typeof window !== "undefined";
    const anchorElement = anchorElem || (isClientSide && document.body);

    // If anchorElement is still null or not on the client-side, we can't proceed with creating the portal
    if (!isClientSide || !anchorElement) {
      return () => {}
    }
